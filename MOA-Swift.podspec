#
#  Be sure to run `pod spec lint moa-swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://itnext.io/module-oriented-architecture-4b54c8976415"
  ...
  # Or just: s.author    = "Mladen Despotovic"
  # s.authors            = { "Mladen Despotovic" => "mladen.despotovic@1und1.de" }
  ...
  s.source       = { :git => "https://github.com/poksi592/MOA-Swift", :tag => "0.1.0" }
  ...
  s.source_files  = "Helpers/*", "Application Services/*", "Routing/*"
  s.exclude_files = "Application Services/Examples/*"
